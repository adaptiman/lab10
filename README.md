...
This tutorial was originally written and developed by [Prakhar Srivastav](http://prakhar.me) and modified by [David Sweeney](https://adaptiman.github.io) for TCMG303 to include how to setup an Azure Kubernetes cluster to support a multi-container application.

<a href="#top" class="top" id="getting-started">Top</a>

## Using this Document
This document contains a series of several sections, each of which explains a particular aspect of deploying Docker containers. In each section, we will be typing commands (or writing code).
